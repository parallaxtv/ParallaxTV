  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 group/volume relative ml-4">
          ...
          <div className="w-0 overflow-hidden group-hover/volume:w-20 transition-all duration-300 flex items-center">
            <input type="range" min="0" max="1" step="0.01" value={isMuted ? 0 : volume} onChange={onVolumeChange} className="w-full h-1 bg-white/20 rounded-full appearance-none accent-[#38bdf8] cursor-pointer" />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <button onClick={onToggleSettings} className={`transition-colors ${showSettings ? "text-[#38bdf8]" : "text-white/80 hover:text-white"}`}>
